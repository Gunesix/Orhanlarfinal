...
export default function Hero() {
  ...
  const title = settings?.heroTitle || "Muğla Dalaman’da Güvenilir Hafriyat Hizmetleri";
  const subtitle = settings?.heroSubtitle || "Muğla Dalaman'ın Öncü Firması";
  const description = settings?.heroDescription || "Profesyonel ekipmanlarımız ve uzman kadromuzla; kazı, dolgu, yıkım ve kepçe kiralama hizmetlerinde yanınızdayız. Projelerinizi zamanında ve güvenle tamamlıyoruz.";
